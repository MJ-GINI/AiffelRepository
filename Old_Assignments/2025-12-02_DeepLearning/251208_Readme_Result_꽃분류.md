...
|:-----|:------------------------|:------------|:------------------|:---------------------|
| 1차 | 기본 전이 학습 | VGG16 | 71.88% | 기존 약 11분 -> 하드웨어 가속기 T4 GPU 변경 후 43초 |
| 2차 | 경량화 모델로 변경 및 재학습 | MobileNetV2 | 84.38% | 약 4~5초 |
| 3차 | Fine-tuning | MobileNetV2 | 91.28% | 약 4~5초 |
...
- 학습 시간 대폭 단축 및 1차 72% 대비 12%p 향상된 84% 기록
